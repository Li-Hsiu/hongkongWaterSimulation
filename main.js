...
var camera, scene, renderer, ocean, ocean2, oceanSurface, mainDirectionalLight, sky, phi, loadingManager, isLoaded = false, cubeMesh, modelStrings, controls, options, isAnimating = true;
var points = [];
var pointCoords = [];
var delaunay = null;
